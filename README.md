...
**[Vet clinic]** is a relational database that contains data structure for a vet clinic.

## 🛠 Built With <a name="built-with">PostgreSQL</a>

### Tech Stack <a name="tech-stack">SQL</a>

> SQL is a programming language used to access and manipulate data held in relational databases.
...
- git clone https://github.com/willy836/Vet-clinic.git
- cd /Vet-clinic
- open with a code editor eg VSCode
...
Feel free to check the [issues page](https://github.com/willy836/Vet-clinic/issues).
